...
tab-groups-promo-heading = Organiza tus pestañas con grupos de pestañas
# Body text of a New Tab promo explaining how to create a tab group in Firefox
tab-groups-promo-body = Arrastra una pestaña encima de otra para crear un grupo y mantenerte concentrado al navegar.
