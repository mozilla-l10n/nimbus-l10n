...
def add_comment(repo, issue_number, filename, translations, api_token):
    # Add comment to issue with the translations
...
Here’s the data to copy in the Localization field in Nimbus:
...
def main():
    ...
    for exp_details in experiments.values():
        ...
        if os.path.exists(json_filename):
            ...
            # is not marked yet in experiments.json, add a comment to the issue.
