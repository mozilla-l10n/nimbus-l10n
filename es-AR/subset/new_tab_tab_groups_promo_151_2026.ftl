...
tab-groups-promo-heading = Organice sus pestañas con grupos de pestañas
# Body text of a New Tab promo explaining how to create a tab group in Firefox
tab-groups-promo-body = Arrastre una pestaña encima de otra para crear un grupo y mantenerse concentrado al navegar.
# Label for the primary button in the Tab Groups New Tab promo; clicking it starts a tab group with the current tab
tab-groups-promo-primary-button-label = Crear un grupo de pestañas
...
tab-groups-promo-demo-title = Mire cómo funcionan los grupos de pestañas
# Subtitle of the spotlight demo describing how to create a tab group
tab-groups-promo-demo-subtitle = Arrastre una pestaña encima de otra para crear un grupo.
# Label for the dismiss button at the end of the Tab Groups demo spotlight
tab-groups-promo-demo-primary-button-label = Entendido
